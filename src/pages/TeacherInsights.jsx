...
//  - MarkingQueue: AI judgements that deserve a human eye (low confidence,
//    partial credit, handwriting, offline fallbacks) with 1-click
//    approve / override.
            ...
            return (
              <div key={`${e.attempt.id}-${e.index}-${qi}`} style={{ padding: 14, borderRadius: 14, background: fill(0.03), border: `1px solid ${fill(0.08)}` }}>
                ...
                <div style={{ display: 'flex', gap: 8, marginTop: 10, flexWrap: 'wrap', alignItems: 'center' }}>
                  <button style={chipBtn(t, t.OK)} onClick={() => resolve(e, {}, 'approved')}>✓ Approve AI mark</button>
                  <button style={chipBtn(t, '#3E6FE0')} onClick={() => resolve(e, { score: 1, correct: true }, 'full marks')}>Full marks</button>
                  <button style={chipBtn(t, t.CORAL)} onClick={() => resolve(e, { score: 0, correct: false }, 'zero')}>Zero</button>
